...
public class Controller_MPC implements Controller{
	...
	public Controller_MPC (double ref,double IPTG0,BSim sim) {
		this.ref=ref;
	...
	public double[] Evaluate_Error(Vector<BSimControlledBacterium> bacteria) {
		...
		state_per[0]=bacteria.get(ind_bact).y[2];
		state_per[1]=bacteria.get(ind_bact).y[3];
		
		
		
		curr_e[0]=ref-state_per[1];
